...
const selectActiveFilterCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSelector"])(selectFilters, (f)=>f.types.length + f.experience.length + f.workMode.length + f.categories.length + (f.location ? 1 : 0));
...
const selectSavedJobObjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSelector"])(selectAllJobs, selectSavedJobIds, (jobs, ids)=>jobs.filter((j)=>ids.includes(j.id)));
const selectAppliedJobObjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSelector"])(selectAllJobs, selectAppliedJobIds, (jobs, ids)=>jobs.filter((j)=>ids.includes(j.id)));
...
"[project]/src/store/Provider.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__84a2024d._.js.map