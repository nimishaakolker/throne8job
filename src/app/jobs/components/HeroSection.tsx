...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f7f3ef] mt-12">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-2 gap-10 items-center">

        {/* ── LEFT: heading + stats ── */}
        <div className="relative">

          {/* Eyebrow */}
          <p className="relative text-[11px] font-bold text-[#c9a882] uppercase tracking-[0.2em] mb-3">
            — Your next chapter
          </p>
          ...
          {/* Subtext with left accent */}
          <div className="flex gap-3 mt-5 max-w-[360px]">
          ...
          <div className="flex gap-2.5 mt-7">
            {[
              ...
              >
                <p className="text-[21px] font-black text-[#2d1f14] leading-none tracking-tight">{n}</p>
                <p className="text-[9.5px] text-[#6b5847]/50 font-semibold mt-1.5 uppercase tracking-[0.1em]">{l}</p>
              </div>
            ))}
          </div>
        </div>
