  ...
  return (
    <div className="grid grid-cols-4 gap-3 mb-8">
      {[
        ...
        <div key={label} className="bg-white border border-[#d4c4b5] rounded-2xl px-5 py-4 shadow-sm">
    ...
    <div className="min-h-screen bg-[#f7f3ef]">
      <header className="sticky top-14 z-40 border-b border-[#d4c4b5] bg-[#f7f3ef]/90 backdrop-blur-xl">
        <div className="max-w-5xl mx-auto px-6 h-12 flex items-center gap-4">
          ...
          <Link href="/saved" className="ml-auto text-sm font-semibold text-[#6b5847] hover:text-[#4a3728] transition-colors">
            View Saved →
          </Link>
        </div>
      </header>
